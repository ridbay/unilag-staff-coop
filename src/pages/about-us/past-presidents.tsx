...
const PastPresidents = () => {
    ...
    return (
      <AboutLayout>
        <div>
          <h1 className='text-[2rem] font-semibold'>Past President</h1>
          <h2 className='text-[1rem]'>
            ...
            about the continuous growth and development being witnessed by
            members of the Society. They are as follows in chronological order:
          </h2>
          <div className='mt-8'>
